                                        ...
                                        <tbody>
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="text-center">
                                                    <span style="border-radius: 5px; font-size: 11px" class="bg-info px-2 text-white">ongoing</span>
                                                </td>
                                                <td class="text-center">Mrs. Dewi Sinta, Ph.D.</td>
                                                <td class="text-center">
                                                    <a href="/pembimbing/detailMonitoring" style="font-size: 12px;" class=" btn-small btn btn-warning">Detail</a>
                                                </td>
                                            </tr>
                                            <tr role="row" class="odd">
