                                        ...
                                        <tbody>
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="text-center">
                                                    <span style="border-radius: 5px; font-size: 11px" class="bg-success px-2 text-white">lulus</span>
                                                </td>
                                                <td class="text-center">Mrs. Dewi Sinta, Ph.D.</td>
                                                <td class="text-center">
                                                    <a href="/pembimbing/detailRiwayat" style="font-size: 12px;" class=" btn-small btn btn-primary">Detail</a>
                                                </td>
                                            </tr>
                                            <tr role="row" class="odd">
