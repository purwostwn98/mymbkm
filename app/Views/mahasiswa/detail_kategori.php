...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
                                            ...
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td style="width: 40px;" class="text-center">
                                                            <a href="/mahasiswa/halamanAjuan" style="font-size: 12px;" class="btn-small btn btn-primary">Ajukan</a>
                                                        </td>
                                                    </tr>
                                                    <tr role="row" class="odd">
        ...
        <div class="row">
            <div class="col">
                <span style="font-size: 14px;"><i># Jika terdapat project yang belum terdapat di tabel mohon konfirmasi ke kaprodi masing-masing. </i></span>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col">
        <a href="/mahasiswa/daftarMBKM" class="btn btn-warning btn-icon-split">
            ...
            <form method="POST" id="formFilter" action="#">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputAddress2" name="tgAkhir" value="25 Desember 2021" readonly>
                    </div>
                    <div class="form-group">
